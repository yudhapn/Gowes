...
import id.forum.core.post.presentation.PostPagingAdapter.PostAdapterListener
import id.forum.core.post.presentation.PostAttachmentAdapter.AttachmentAdapterListener

class PostPagingViewHolder(
    private val binding: ItemListPostPagingBinding,
    ...
    fun bind(post: Post, isAdmin: Boolean) {
        binding.apply {
            this.currentUserId = this@PostPagingViewHolder.currentUserId
            this.post = post
